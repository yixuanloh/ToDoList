...
@Injectable()
export class TDListServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getAll(): Observable<TDListDto[]> {
        let url_ = this.baseUrl + "/api/services/app/TDList/GetAll";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TDListDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<TDListDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<TDListDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200.push(TDListDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
        ...
        return _observableOf<TDListDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<TDItemDto[]> {
        let url_ = this.baseUrl + "/api/services/app/TDList/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TDItemDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<TDItemDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<TDItemDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(TDItemDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
        ...
        return _observableOf<TDItemDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    create(body: TDListDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/TDList/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    createItem(body: TDItemDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/TDList/CreateItem";
        url_ = url_.replace(/[?&]$/, "");
    ...
    delete(id: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/TDList/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
    ...
    deleteItem(id: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/TDList/DeleteItem?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    updateItem(id: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/TDList/UpdateItem?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
...
export class TDItemDto implements ITDItemDto {
    title: string | undefined;
    description: string | undefined;
    status: boolean;
    timeToStart: moment.Moment;
    toDoRefId: string;
    id: string;

    constructor(data?: ITDItemDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.timeToStart = _data["timeToStart"] ? moment(_data["timeToStart"].toString()) : <any>undefined;
            this.toDoRefId = _data["toDoRefId"];
            this.id = _data["id"];
        }
    }

    static fromJS(data: any): TDItemDto {
        data = typeof data === 'object' ? data : {};
        let result = new TDItemDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["timeToStart"] = this.timeToStart ? this.timeToStart.toISOString() : <any>undefined;
...
export class TDListDto implements ITDListDto {
    title: string | undefined;
    creationTime: moment.Moment;
    status: boolean;
    toDoItemList: TDItemDto[] | undefined;
    id: string;

    constructor(data?: ITDListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.creationTime = _data["creationTime"] ? moment(_data["creationTime"].toString()) : <any>undefined;
            this.status = _data["status"];
            if (Array.isArray(_data["toDoItemList"])) {
                this.toDoItemList = [] as any;
                for (let item of _data["toDoItemList"])
                    this.toDoItemList.push(TDItemDto.fromJS(item));
            }
            this.id = _data["id"];
        }
    }

    static fromJS(data: any): TDListDto {
        data = typeof data === 'object' ? data : {};
        let result = new TDListDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["creationTime"] = this.creationTime ? this.creationTime.toISOString() : <any>undefined;
        data["status"] = this.status;
        if (Array.isArray(this.toDoItemList)) {
            data["toDoItemList"] = [];
            for (let item of this.toDoItemList)
                data["toDoItemList"].push(item.toJSON());
        }
        data["id"] = this.id;
        return data; 
    }
